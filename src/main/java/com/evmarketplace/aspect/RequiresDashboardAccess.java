...
/**
 * Annotation đánh dấu các method yêu cầu quyền truy cập dashboard/API của dataset.
 * Khi method được đánh dấu bởi annotation này, AccessControlAspect sẽ tự động
 * kiểm tra quyền AccessType.API trước khi cho phép thực thi method.
 * 
 * Sử dụng: @RequiresDashboardAccess
...
public @interface RequiresDashboardAccess {
}